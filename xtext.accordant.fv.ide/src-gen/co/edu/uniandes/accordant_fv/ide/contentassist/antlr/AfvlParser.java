		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDeliveryGuaranteeAccess().getAlternatives(), "rule__DeliveryGuarantee__Alternatives");
					...
					put(grammarAccess.getPortAccess().getGroup_5_4(), "rule__Port__Group_5_4__0");
					...
					put(grammarAccess.getTransformerAccess().getGroup_6(), "rule__Transformer__Group_6__0");
					put(grammarAccess.getTransformerAccess().getGroup_11(), "rule__Transformer__Group_11__0");
					...
					put(grammarAccess.getEstimatorAccess().getGroup_6(), "rule__Estimator__Group_6__0");
					put(grammarAccess.getEstimatorAccess().getGroup_11(), "rule__Estimator__Group_11__0");
					...
					put(grammarAccess.getIngestorAccess().getGroup_16(), "rule__Ingestor__Group_16__0");
					...
					put(grammarAccess.getSinkAccess().getGroup_11(), "rule__Sink__Group_11__0");
					put(grammarAccess.getSinkAccess().getGroup_16(), "rule__Sink__Group_16__0");
					...
					put(grammarAccess.getPortAccess().getFieldsAssignment_5_3(), "rule__Port__FieldsAssignment_5_3");
					put(grammarAccess.getPortAccess().getFieldsAssignment_5_4_1(), "rule__Port__FieldsAssignment_5_4_1");
					...
					put(grammarAccess.getTransformerAccess().getDeliveryAssignment_4_2(), "rule__Transformer__DeliveryAssignment_4_2");
					put(grammarAccess.getTransformerAccess().getPmmlAssignment_5_2(), "rule__Transformer__PmmlAssignment_5_2");
					put(grammarAccess.getTransformerAccess().getDecisionAssignment_6_2(), "rule__Transformer__DecisionAssignment_6_2");
					put(grammarAccess.getTransformerAccess().getPortsAssignment_10(), "rule__Transformer__PortsAssignment_10");
					put(grammarAccess.getTransformerAccess().getPortsAssignment_11_1(), "rule__Transformer__PortsAssignment_11_1");
					...
					put(grammarAccess.getEstimatorAccess().getDeliveryAssignment_4_2(), "rule__Estimator__DeliveryAssignment_4_2");
					put(grammarAccess.getEstimatorAccess().getPmmlAssignment_5_2(), "rule__Estimator__PmmlAssignment_5_2");
					put(grammarAccess.getEstimatorAccess().getDecisionAssignment_6_2(), "rule__Estimator__DecisionAssignment_6_2");
					put(grammarAccess.getEstimatorAccess().getPortsAssignment_10(), "rule__Estimator__PortsAssignment_10");
					put(grammarAccess.getEstimatorAccess().getPortsAssignment_11_1(), "rule__Estimator__PortsAssignment_11_1");
					...
					put(grammarAccess.getIngestorAccess().getDeliveryAssignment_7_2(), "rule__Ingestor__DeliveryAssignment_7_2");
					put(grammarAccess.getIngestorAccess().getConnAssignment_8_2(), "rule__Ingestor__ConnAssignment_8_2");
					put(grammarAccess.getIngestorAccess().getFormatAssignment_9_2(), "rule__Ingestor__FormatAssignment_9_2");
					put(grammarAccess.getIngestorAccess().getPropsAssignment_10_2(), "rule__Ingestor__PropsAssignment_10_2");
					put(grammarAccess.getIngestorAccess().getDecisionAssignment_11_2(), "rule__Ingestor__DecisionAssignment_11_2");
					put(grammarAccess.getIngestorAccess().getPortsAssignment_15(), "rule__Ingestor__PortsAssignment_15");
					put(grammarAccess.getIngestorAccess().getPortsAssignment_16_1(), "rule__Ingestor__PortsAssignment_16_1");
					...
					put(grammarAccess.getSinkAccess().getDeliveryAssignment_7_2(), "rule__Sink__DeliveryAssignment_7_2");
					put(grammarAccess.getSinkAccess().getConnAssignment_8_2(), "rule__Sink__ConnAssignment_8_2");
					put(grammarAccess.getSinkAccess().getFormatAssignment_9_2(), "rule__Sink__FormatAssignment_9_2");
					put(grammarAccess.getSinkAccess().getPropsAssignment_10_2(), "rule__Sink__PropsAssignment_10_2");
					put(grammarAccess.getSinkAccess().getDecisionAssignment_11_2(), "rule__Sink__DecisionAssignment_11_2");
					put(grammarAccess.getSinkAccess().getPortsAssignment_15(), "rule__Sink__PortsAssignment_15");
					put(grammarAccess.getSinkAccess().getPortsAssignment_16_1(), "rule__Sink__PortsAssignment_16_1");
					put(grammarAccess.getFieldAccess().getNameAssignment_0(), "rule__Field__NameAssignment_0");
					put(grammarAccess.getFieldAccess().getDtypeAssignment_2(), "rule__Field__DtypeAssignment_2");
					put(grammarAccess.getFieldAccess().getOrderAssignment_4(), "rule__Field__OrderAssignment_4");
				}
			};
		}
