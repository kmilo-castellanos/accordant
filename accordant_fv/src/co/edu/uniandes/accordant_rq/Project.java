 ...
 * </p>
 * <ul>
 *   <li>{@link co.edu.uniandes.accordant_rq.Project#getName <em>Name</em>}</li>
 *   <li>{@link co.edu.uniandes.accordant_rq.Project#getScenarios <em>Scenarios</em>}</li>
 *   <li>{@link co.edu.uniandes.accordant_rq.Project#getTactics <em>Tactics</em>}</li>
 *   <li>{@link co.edu.uniandes.accordant_rq.Project#getAnalyzedQs <em>Analyzed Qs</em>}</li>
 *   <li>{@link co.edu.uniandes.accordant_rq.Project#getConstraints <em>Constraints</em>}</li>
 * </ul>
 *
 * @see co.edu.uniandes.accordant_rq.Accordant_rqPackage#getProject()
 * @model
 * @generated
 */
public interface Project extends EObject {
	 ...
	 * @see #setName(String)
	 * @see co.edu.uniandes.accordant_rq.Accordant_rqPackage#getProject_Name()
	...
	/**
	 * Sets the value of the '{@link co.edu.uniandes.accordant_rq.Project#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see co.edu.uniandes.accordant_rq.Accordant_rqPackage#getProject_Scenarios()
	 ...
	 * @see co.edu.uniandes.accordant_rq.Accordant_rqPackage#getProject_Tactics()
	 ...
	 * @see co.edu.uniandes.accordant_rq.Accordant_rqPackage#getProject_AnalyzedQs()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see co.edu.uniandes.accordant_rq.Accordant_rqPackage#getProject_Constraints()
	 * @model containment="true"
	 * @generated
	 */
