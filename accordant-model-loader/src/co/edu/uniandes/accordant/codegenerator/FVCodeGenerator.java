...
import co.edu.uniandes.accordant_fv.generator.AfvlGenerator;
import co.edu.uniandes.accordant_rq.Accordant_rqPackage;

public class FVCodeGenerator {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		new FVCodeGenerator().generate(
				"/Volumes/MacHD2/Desarrollo/accordant/accordant/accordant-model-loader/ChurnEstimation_Churn-FV_fv.xmi",
				"/Volumes/MacHD2/Desarrollo/accordant/accordant/accordant-model-loader/src-gen");
	...
	public void generate(String file, String outputPath) {
		...
		AfvlGenerator gen = new AfvlGenerator();
