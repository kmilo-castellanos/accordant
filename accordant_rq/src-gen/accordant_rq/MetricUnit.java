 ...
 * <!-- end-user-doc -->
 * @see accordant_rq.Accordant_rqPackage#getMetricUnit()
 * @model
 * @generated
 */
public enum MetricUnit implements Enumerator {
	 ...
	 * @generated
	 */
	private static final MetricUnit[] VALUES_ARRAY = new MetricUnit[] { MILLIS, SECONDS, MINUTES, HOURS, TASKS, BYTES,
			MSGS, };
