...
public class SensitivityPointImpl extends MinimalEObjectImpl.Container implements SensitivityPoint {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Accordant_rqPackage.SENSITIVITY_POINT__NAME, oldName, name));
	}
	...
	public void setRationale(String newRationale) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Accordant_rqPackage.SENSITIVITY_POINT__RATIONALE, oldRationale, rationale));
	}
	...
	public void setCode(String newCode) {
		...
		code = newCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Accordant_rqPackage.SENSITIVITY_POINT__CODE, oldCode, code));
	}
	...
	public void setIsRisk(boolean newIsRisk) {
		...
		isRisk = newIsRisk;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Accordant_rqPackage.SENSITIVITY_POINT__IS_RISK, oldIsRisk, isRisk));
	}
