 ...
 * @generated
 */
public class Accordant_rqSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Accordant_rqPackage.QSCENARIO: {
				QScenario qScenario = (QScenario)theEObject;
				T result = caseQScenario(qScenario);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Accordant_rqPackage.ANALYZED_QS: {
				AnalyzedQS analyzedQS = (AnalyzedQS)theEObject;
				T result = caseAnalyzedQS(analyzedQS);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>QScenario</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>QScenario</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseQScenario(QScenario object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Analyzed QS</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Analyzed QS</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAnalyzedQS(AnalyzedQS object) {
		return null;
	}
