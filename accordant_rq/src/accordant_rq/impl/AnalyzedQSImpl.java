 ...
 * </p>
 * <ul>
 *   <li>{@link accordant_rq.impl.AnalyzedQSImpl#getPoints <em>Points</em>}</li>
 *   <li>{@link accordant_rq.impl.AnalyzedQSImpl#getQs <em>Qs</em>}</li>
 *   <li>{@link accordant_rq.impl.AnalyzedQSImpl#getReasoning <em>Reasoning</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnalyzedQSImpl extends MinimalEObjectImpl.Container implements AnalyzedQS {
	...
	public NotificationChain basicSetPoints(SensitivityPoint newPoints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Accordant_rqPackage.ANALYZED_QS__POINTS, oldPoints, newPoints);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setPoints(SensitivityPoint newPoints) {
		if (newPoints != points) {
			...
			if (points != null)
				msgs = ((InternalEObject) points).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Accordant_rqPackage.ANALYZED_QS__POINTS, null, msgs);
			if (newPoints != null)
				msgs = ((InternalEObject) newPoints).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - Accordant_rqPackage.ANALYZED_QS__POINTS, null, msgs);
			...
			eNotify(
					new ENotificationImpl(this, Notification.SET, Accordant_rqPackage.ANALYZED_QS__POINTS, newPoints, newPoints));
	}
	...
	public NotificationChain basicSetQs(QScenario newQs, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Accordant_rqPackage.ANALYZED_QS__QS, oldQs, newQs);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setQs(QScenario newQs) {
		if (newQs != qs) {
			NotificationChain msgs = null;
			if (qs != null)
				msgs = ((InternalEObject) qs).eInverseRemove(this, Accordant_rqPackage.QSCENARIO__ANALYZED, QScenario.class,
						msgs);
			if (newQs != null)
				msgs = ((InternalEObject) newQs).eInverseAdd(this, Accordant_rqPackage.QSCENARIO__ANALYZED, QScenario.class,
						msgs);
	...
	public void setReasoning(String newReasoning) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Accordant_rqPackage.ANALYZED_QS__REASONING, oldReasoning,
					reasoning));
	}
