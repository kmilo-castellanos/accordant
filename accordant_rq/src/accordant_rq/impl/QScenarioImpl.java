 ...
 * </p>
 * <ul>
 *   <li>{@link accordant_rq.impl.QScenarioImpl#getMeasure <em>Measure</em>}</li>
 *   <li>{@link accordant_rq.impl.QScenarioImpl#getMinValue <em>Min Value</em>}</li>
 *   <li>{@link accordant_rq.impl.QScenarioImpl#getMaxValue <em>Max Value</em>}</li>
 *   <li>{@link accordant_rq.impl.QScenarioImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link accordant_rq.impl.QScenarioImpl#getQAttribute <em>QAttribute</em>}</li>
 *   <li>{@link accordant_rq.impl.QScenarioImpl#getAnalyzed <em>Analyzed</em>}</li>
 *   <li>{@link accordant_rq.impl.QScenarioImpl#getStimulus <em>Stimulus</em>}</li>
 *   <li>{@link accordant_rq.impl.QScenarioImpl#getEnvironment <em>Environment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QScenarioImpl extends MinimalEObjectImpl.Container implements QScenario {
	...
	public void setMeasure(QAMetric newMeasure) {
		...
		if (eNotificationRequired())
			eNotify(
					new ENotificationImpl(this, Notification.SET, Accordant_rqPackage.QSCENARIO__MEASURE, oldMeasure, measure));
	}
	...
	public void setMinValue(float newMinValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Accordant_rqPackage.QSCENARIO__MIN_VALUE, oldMinValue,
					minValue));
	}
	...
	public void setMaxValue(float newMaxValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Accordant_rqPackage.QSCENARIO__MAX_VALUE, oldMaxValue,
					maxValue));
	}
	...
	public void setQAttribute(QAttribute newQAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Accordant_rqPackage.QSCENARIO__QATTRIBUTE, oldQAttribute,
					qAttribute));
	}
	...
	public AnalyzedQS getAnalyzed() {
		if (analyzed != null && analyzed.eIsProxy()) {
			...
			if (analyzed != oldAnalyzed) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Accordant_rqPackage.QSCENARIO__ANALYZED,
							oldAnalyzed, analyzed));
			}
		}
		return analyzed;
	}
	...
	public NotificationChain basicSetAnalyzed(AnalyzedQS newAnalyzed, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Accordant_rqPackage.QSCENARIO__ANALYZED, oldAnalyzed, newAnalyzed);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setAnalyzed(AnalyzedQS newAnalyzed) {
		if (newAnalyzed != analyzed) {
			...
			if (analyzed != null)
				msgs = ((InternalEObject) analyzed).eInverseRemove(this, Accordant_rqPackage.ANALYZED_QS__QS, AnalyzedQS.class,
						msgs);
			if (newAnalyzed != null)
				msgs = ((InternalEObject) newAnalyzed).eInverseAdd(this, Accordant_rqPackage.ANALYZED_QS__QS, AnalyzedQS.class,
						msgs);
			msgs = basicSetAnalyzed(newAnalyzed, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Accordant_rqPackage.QSCENARIO__ANALYZED, newAnalyzed,
					newAnalyzed));
	}
	...
	public void setStimulus(String newStimulus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Accordant_rqPackage.QSCENARIO__STIMULUS, oldStimulus,
					stimulus));
	}
	...
	public void setEnvironment(String newEnvironment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Accordant_rqPackage.QSCENARIO__ENVIRONMENT, oldEnvironment,
					environment));
	}
